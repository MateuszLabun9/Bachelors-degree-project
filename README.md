...
In this stage on touch display will be generated another numeric keyboard with label informing that sms code is needed. Access granted when satisfy all conditions.
